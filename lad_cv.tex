...
\hangindent=0.5in $\bullet$\hspace{.1in} Faculty Pilot Research Grant,
Duke Center for Genomic \& Computational Biology ``Discovering natural bacterial interactions to control the human gut microbiota'' (\$50K) Co-PI:
Lawrence David; 02/2015-01/2016. \\

\vspace{-10mm}

\hangindent=0.5in $\bullet$\hspace{.1in} Travel Grant, Duke-NUS
Graduate Medical School, Singapore. 2014-2015. \\
...
\vspace{.25in}
\begin{list1}
\item[] 2014 - Alfred P. Sloan Research Fellow % (\$50K)
...
$\bullet$\hspace{.1in} (Duke) Justin Silverman, MD/PhD student, 2014- \\
$\bullet$\hspace{.1in} (Duke) Anchi Wu, undergrad research,
2014- \\
$\bullet$\hspace{.1in} (Duke) Firas Midani, Computational Biology \& Bioinformatics, PhD student, 2014- \\
